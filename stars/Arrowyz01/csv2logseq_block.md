---
repo: Arrowyz01/csv2logseq_block
url: 'https://github.com/Arrowyz01/csv2logseq_block'
homepage: ''
starredAt: '2022-12-29T06:58:23Z'
createdAt: '2022-01-31T19:14:31Z'
updatedAt: '2025-06-24T17:41:44Z'
language: Python
license: GPL-3.0
branch: main
stars: 44
...
isFork: false
hasReadMe: true
refreshedAt: '2025-12-29T17:35:04.212Z'
description: >-
  Python script that can read csv file and output a markdown file containing
  logseq block and block properties (from csv data), and a basic query script to
  generate a table query (like the format in csv file). The goal is to simulate
  notion table database in logseq. Also come with a script to reverse!
tags:
  - csv
  - logseq
  - markdown
