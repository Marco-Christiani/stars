---
repo: adamtheturtle/doccmd
url: 'https://github.com/adamtheturtle/doccmd'
homepage: 'https://adamtheturtle.github.io/doccmd/'
starredAt: '2026-02-23T20:32:41Z'
createdAt: '2024-09-09T00:07:54Z'
updatedAt: '2026-02-28T10:30:42Z'
language: Python
license: MIT
branch: main
stars: 25
...
isFork: false
hasReadMe: true
refreshedAt: '2026-02-28T22:32:31.162Z'
description: Run commands against code blocks in Markdown or reStructuredText documentation
tags: []
---
...
.. code-block:: console
   ...
   $ curl --fail -L https://github.com/adamtheturtle/doccmd/releases/download/2026.02.27.1/doccmd-linux -o /usr/local/bin/doccmd &&
...
.. code-block:: console
   ...
   $ curl --fail -L https://github.com/adamtheturtle/doccmd/releases/download/2026.02.27.1/doccmd-macos -o /usr/local/bin/doccmd &&
       chmod +x /usr/local/bin/doccmd
...
.. code-block:: shell
   ...
   $ nix --extra-experimental-features 'nix-command flakes' run "github:adamtheturtle/doccmd/2026.02.27.1" -- --help
