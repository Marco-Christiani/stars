---
repo: onikan27/claude-code-monitor
url: 'https://github.com/onikan27/claude-code-monitor'
homepage: ''
starredAt: '2026-02-17T06:53:18Z'
createdAt: '2026-01-17T07:59:45Z'
updatedAt: '2026-02-21T15:35:09Z'
language: TypeScript
license: MIT
branch: main
stars: 185
...
isFork: false
hasReadMe: true
refreshedAt: '2026-02-21T22:32:42.830Z'
description: >-
  Real-time dashboard for monitoring multiple Claude Code sessions. CLI + Mobile
  Web UI with QR code access, terminal focus   switching (iTerm2, Terminal.app,
  Ghostty). macOS only.
tags:
  - claude
  - claude-code
