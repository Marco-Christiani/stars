...
starredAt: '2022-10-21T23:18:55Z'
createdAt: '2021-06-30T01:16:04Z'
updatedAt: '2025-11-27T12:00:08Z'
language: C++
license: Apache-2.0
branch: master
stars: 817
...
isFork: false
hasReadMe: true
refreshedAt: '2025-12-29T17:35:13.828Z'
description: >-
  Tuplex is a parallel big data processing framework that runs data science
  pipelines written in Python at the speed of compiled code. Tuplex has similar
  Python APIs to Apache Spark or Dask, but rather than invoking the Python
  interpreter, Tuplex generates optimized LLVM bytecode for the given pipeline
  and input data set.
tags: []
---
